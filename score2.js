function initialise() {
  ...
  function result(myScore) {
    // alert("result");
     if (myScore>60) { myContentsPtr = 5; }
        else { if (myScore > 50) { myContentsPtr = 4; }
          else { if(myScore>40)  { myContentsPtr = 3; } 
              else { if(myScore>29) { myContentsPtr = 2; }
              else { if(myScore>10) { myContentsPtr = 1; }
