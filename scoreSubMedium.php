...
">Congratulations!</span>
    ...
    <?php
        ...
        ?>
           <div class="text-center display-4 mt-5"><span class="badge badge-danger"><?php echo($_POST['unameN']);?> your Medium Level score is <?php echo($_POST['score']);?></span></div>
           <!-- <h1> <?php echo($_POST['unameN']);?></h1> -->
           <?php
           $quer = "update dashboard set mscore = ".$_POST['score']." where name ='".$_POST['unameN']."'";
